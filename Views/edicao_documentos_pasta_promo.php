    ...
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <form enctype="multipart/form-data" action="upload_arquivos.php" method="post">
                    ...
                    <div class="input-group">
                        ...
                        <input type="hidden" name="dados_pasta[]" value="<?= $semestre_pasta ?>">
                        <input type="hidden" name="dados_pasta[]" value="<?= $ano_pasta ?>">
